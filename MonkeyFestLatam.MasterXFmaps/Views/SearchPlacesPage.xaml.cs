...
{
    public partial class SearchPlacesPage : ContentPage
    {
       /* public static readonly BindableProperty CalculateCommandProperty =
           BindableProperty.Create(nameof(CalculateCommand), typeof(ICommand), typeof(SearchPlacesPage), null, BindingMode.TwoWay);
        ...
        public static readonly BindableProperty UpdateCommandProperty =
          BindableProperty.Create(nameof(UpdateCommand), typeof(ICommand), typeof(SearchPlacesPage), null, BindingMode.TwoWay);
        ...
        async void Update(Xamarin.Forms.GoogleMaps.Position position)
        {
            ...
            if (cPin != null)
            {
                ...
                cPin.Icon = BitmapDescriptorFactory.FromView(new Image() { Source = "car.png", WidthRequest = 25, HeightRequest = 25 });
        ...
        void Calculate(List<Xamarin.Forms.GoogleMaps.Position> list)
        {
            ...
            var pin = new Xamarin.Forms.GoogleMaps.Pin
            {
                ...
                Address = "First",
                Tag = string.Empty,
                Icon = BitmapDescriptorFactory.FromView(new Image() { Source = "car.png", WidthRequest = 25, HeightRequest = 25 })
