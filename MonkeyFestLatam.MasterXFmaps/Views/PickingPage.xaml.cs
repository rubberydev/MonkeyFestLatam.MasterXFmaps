...
namespace MonkeyFestLatam.MasterXFmaps.Views
{
    public partial class PickingPage : ContentPage
    {
        public static readonly BindableProperty CalculateCommandProperty =
           BindableProperty.Create(nameof(CalculateCommand), typeof(ICommand), typeof(PickingPage), null, BindingMode.TwoWay);
        ...
        public static readonly BindableProperty UpdateCommandProperty =
          BindableProperty.Create(nameof(UpdateCommand), typeof(ICommand), typeof(PickingPage), null, BindingMode.TwoWay);
        ...
        {
            InitializeComponent();
            CalculateCommand = new Command<List<Xamarin.Forms.GoogleMaps.Position>>(CalculateInitialRoute);
            UpdateCommand = new Command<Xamarin.Forms.GoogleMaps.Position>(UpdateRoute);
        ...
        void CalculateInitialRoute(List<Xamarin.Forms.GoogleMaps.Position> list)
        {
        ...
        {
            await Navigation.PushAsync(new SearchPlacePage() { BindingContext = this.BindingContext }, true);
        ...
        public static readonly BindableProperty GetActualLocationCommandProperty =
            BindableProperty.Create(nameof(GetActualLocationCommand), typeof(ICommand), typeof(PickingPage), null, BindingMode.TwoWay);
